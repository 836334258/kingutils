...
var t = {
      ...
      class i {
        ...
        take(t, e = 1) {
          return Array.isArray(t)
            ? Array.prototype.slice.call(t, e < 0 ? 0 : e)
            : []
        }
      }
    },
    42: (t, e, r) => {
      ...
      r.r(e), r.d(e, { createCollection: () => n })
      class i {
        mapArray(t, e) {
          if (!Array.isArray(t)) return []
          let r = -1
          const n = []
          for (; ++r < t.length; ) n[r] = e(t[r], r, t)
          return n
        }
      }
    },
    479: (t, e, r) => {
      ...
      class a {
        isWeakSet(t) {
          return this.isObjectLike(t) && '[object WeakSet]' === this.getTag(t)
        }
        isWeakMap(t) {
          return this.isObjectLike(t) && '[object WeakMap]' === this.getTag(t)
        }
        isUndefined(t) {
          return void 0 === t
        }
        ...
        isString(t) {
          ...
          return (
            ...
            ('object' === e &&
              null !== t &&
              '[object String]' === this.getTag(t))
          )
        }
        isSet(t) {
          return this.isObjectLike(t) && '[object Set]' === this.getTag(t)
        }
        isSafeInteger(t) {
          return Number.isSafeInteger(t)
        }
        isRegExp(t) {
          return this.isObjectLike(t) && '[object RegExp]' === this.getTag(t)
        }
        isNubmer(t) {
          return (
            'number' == typeof t ||
            (this.isObjectLike(t) && '[object Number]' === this.getTag(t))
          )
        }
        isNull(t) {
          return null === t
        ...
        isMap(t) {
          return h && h.isMap
            ? h.isMap(t)
            : this.isObjectLike(t) && '[object Map]' === this.getTag(t)
        }
        isLength(t) {
          return (
            'number' == typeof t &&
        ...
        isError(t) {
          if (!this.isObjectLike(t)) return !1
        ...
        isElement(t) {
          return (
            this.isObjectLike(t) && 1 === t.nodeType && !this.isPlainObject(t)
          )
        }
        isPlainObject(t) {
          if (!this.isObjectLike(t) || '[object Object]' !== this.getTag(t))
            return !1
          let e = t
          for (; null !== Reflect.getPrototypeOf(e); )
        ...
        isArrayBuffer(t) {
          return (
            this.isObjectLike(t) && '[object ArrayBuffer]' === this.getTag(t)
          )
        }
        isArray(t) {
          return Array.isArray(t)
        ...
        isArguments(t) {
          return this.isObjectLike(t) && '[object Arguments]' === this.getTag(t)
        }
        isObjectLike(t) {
              ...
              isNaN(e) || e === 1 / 0
                ...
                : ((s = Math.floor(Math.log(e) / Math.LN2)),
                  ...
                  s + c >= a
                    ? ((f = 0), (s = a))
                    : s + c >= 1
                    ? ((f = (e * u - 1) * Math.pow(2, i)), (s += c))
                    : ((f = e * Math.pow(2, c - 1) * Math.pow(2, i)), (s = 0)));
            i >= 8;
            t[r + p] = 255 & f, p += g, f /= 256, i -= 8
          );
          for (
            s = (s << i) | f, h += i;
            h > 0;
            t[r + p] = 255 & s, p += g, s /= 256, h -= 8
          );
          t[r + p - g] |= 128 * y
        })
    },
    55: (t, e, r) => {
      var n = { './array.ts': 518, './collection.ts': 42, './util.ts': 479 }
      function i(t) {
        var e = o(t)
        return r(e)
      }
...
var i = n.Z
export { i as default }
//# sourceMappingURL=kingutils.min.js.map
