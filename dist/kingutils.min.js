var r = {
      ...
      class o {
        ...
        take(r, e = 1) {
          return Array.isArray(r)
            ? Array.prototype.slice.call(r, e < 0 ? 0 : e)
            : []
        }
      }
    },
    74: (r, e, t) => {
      ...
      t.r(e), t.d(e, { createCollection: () => n })
      class o {
        mapArray(r, e) {
          if (!Array.isArray(r)) return []
          let t = -1
          const n = []
          for (; ++t < r.length; ) n[t] = e(r[t], t, r)
          return n
        }
      }
    },
    55: (r, e, t) => {
      var n = { './array.ts': 706, './collection.ts': 74 }
      function o(r) {
        var e = a(r)
        return t(e)
      }
